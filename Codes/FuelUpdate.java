 ...
 * @author sa
 */
public class FuelUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Balance Fuel Amount");
        ...
        jLabel11.setText("Now Fuel Amount");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuelUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FuelUpdate().setVisible(true);
            }
        });
    }
